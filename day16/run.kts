...
fun part1(lines: List<String>): Int {
    ...
    val stack = mutableListOf(StackItem('E', Coords(0, 0)))
    ...
    do {
        ...
        println("at $at, tile $tile, direction ${stackItem.direction}")
    ...
    val energized = Diagram(energizedSet.map { it to 'O' }.toMap())
    energized.draw()
